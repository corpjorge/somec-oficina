<template>
    <div class="col-lg-10 mx-auto p-3 py-md-5">
        ...
        <p v-if="!enviando" class="fs-5 col-md-12">A continuación, encontrará una serie de campos que deberá completar
            para enviarnos su solicitud.</p>
            ...
            <div class="col-md-12">
                <form v-if="!enviando" class="needs-validation" autocomplete="off" novalidate
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select form-select-sm" :class="errors.oficinas ? 'is-invalid' : '' "
                                    aria-label="oficinas" v-model="pqr.oficinas">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select form-select-sm" :class="errors.tipo ? 'is-invalid' : '' "
                                    aria-label="tipo" v-model="pqr.tipo">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control form-control-sm"
                                      ...
                                      v-model="pqr.descripcion"></textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" accept=".pdf, .jpg, .gif, .doc" class="form-control form-control-sm"

        ...
        <div class="row ">
            ...
            <form v-if="!datos.estado" class="needs-validation" autocomplete="off" novalidate @submit.prevent="atender">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" :class="errors.observacion_antendido ? 'is-invalid' : '' "
                                  id="descripcion" v-model="datos.observacion_antendido"></textarea>
                        <div class="invalid-feedback">
                            {{ errors.observacion_antendido ? errors.observacion_antendido[0] : '' }}
                        </div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="archivo_antendido" class="col-sm-1 col-form-label">Archivo1:</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control form-control-sm"
                               :class="errors.archivo_antendido ? 'is-invalid' : '' " aria-label="file example"
                               id="archivo_antendido" @change="archivo1">
                        <div class="invalid-feedback">
                            {{ errors.archivo_antendido ? errors.archivo_antendido[0] : '' }}
                        </div>
                    </div>
                </div>
            ...
            <template v-if="datos.estado">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <a v-if="datos.archivo_antendido"
                               :href="'/storage/pqrs/respuestas/'+datos.archivo_antendido" target="_blank">Archivo
                                antendido </a>
                        </div>
                        <div class="col-sm">
            ...
            <template v-if="datos.estado == 'ATENDIDO' ">
                ...
                <form class="needs-validation" autocomplete="off" novalidate @submit.prevent="cerrar">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" :class="errors.observacion_cierre ? 'is-invalid' : '' "
                                      id="descripcion" v-model="datos.observacion_cierre"></textarea>
                            <div class="invalid-feedback">
                                {{ errors.observacion_cierre ? errors.observacion_cierre[0] : '' }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control form-control-sm"
                                   :class="errors.archivo_cierre ? 'is-invalid' : '' " aria-label="file example"
                                   @change="archivo2">
                            <div class="invalid-feedback">{{ errors.archivo_cierre ? errors.archivo_cierre[0] : '' }}
                            </div>
                        </div>
                    </div>
            ...
            <template v-if="datos.estado == 'CERRADO'">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <a v-if="datos.archivo_cierre" :href="'/storage/pqrs/respuestas/'+datos.archivo_cierre"
                               target="_blank">Archivo cierre </a>
                        </div>
                        <div class="col-sm">
...
export default {
    ...
    methods: {
        ...
        async obtenerDatos() {
            await axios.get('/admin/pqrs/editar/' + this.$route.params.id).then(response => {
        ...
        async atender() {
            ...
            await axios.post('/admin/pqrs/atender/' + this.$route.params.id, data).then(() => {
                this.enviando = true;
                this.obtenerDatos();
            }).catch(error => {
        ...
        async cerrar() {
            ...
            await axios.post('/admin/pqrs/cerrar/' + this.$route.params.id, data).then(() => {
                this.enviando = true;
                this.obtenerDatos();
            }).catch(error => {
                this.errors = error.response.data.errors;

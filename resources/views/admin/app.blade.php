...
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #0066b8;">
    <div class="container-fluid">
        <a class="navbar-brand" style="color: #e4dede">Administración</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ url('admin/pqrs') }}">PQRS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page"
                       href="{{ url('admin/clasificados') }}">Clasificados</a>
                </li>
                <li class="nav-item">
